...
Компонент нужен для cоздания выпадающего списка. Особенно он может быть полезным в создании меню сайта. 
...
Способ вставки на страницу зависит от задач. Если у Вас будет один блок раскраывающегося списка на странице, можно просто сделать include на страницу:
